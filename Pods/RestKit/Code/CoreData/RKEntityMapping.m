...
- (id)initWithEntity:(NSEntityDescription *)entity
{
    ...
    Class objectClass_ = NSClassFromString([entity managedObjectClassName]);
    NSAssert(objectClass_, @"Cannot initialize an entity mapping for an entity with a nil managed object class: Got nil class for managed object class name '%@'. Maybe you forgot to add the class files to your target?", [entity managedObjectClassName]);
    self = [self initWithClass:objectClass_];
    if (self) {
        self.entity = entity;
...
- (id)initWithClass:(Class)objectClass_
{
    self = [super initWithClass:objectClass_];
    if (self) {
