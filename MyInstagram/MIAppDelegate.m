...
- (NSURL *)applicationFilesDirectory
{
    ...
    return [appSupportURL URLByAppendingPathComponent:@"self.MyInstagram"];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MyInstagram" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"MyInstagram.storedata"];
