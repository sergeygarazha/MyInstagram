...
@synthesize borderColor, borderWidth, viewMargin, arrowBaseWidth, arrowHeight, hasArrow, cornerRadius, drawsRoundCornerBesideArrow, _MABackgroundColor, _view, _window, _point, _side, _distance, _viewFrame, _resizing;
...
- (BOOL)drawsRoundCornerBesideArrow {
    return self.drawsRoundCornerBesideArrow;
}
