...
@property float viewMargin;
@property float arrowBaseWidth;
@property float arrowHeight;
@property BOOL hasArrow;
@property float cornerRadius;
@property BOOL drawsRoundCornerBesideArrow;
@property (strong) NSColor *_MABackgroundColor;
@property (assign) NSView *_view;
@property (assign) NSWindow *_window;
@property NSPoint _point;
@property MAWindowPosition _side;
@property float _distance;
@property NSRect _viewFrame;
